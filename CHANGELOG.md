...
## [0.1.43](https://github.com/keith-hung/azure-devops-mcp/compare/mcp-server-azure-devops-v0.1.42...mcp-server-azure-devops-v0.1.43) (2025-08-14)


### Features

* add 'expand' option to get_work_item ([6bee365](https://github.com/keith-hung/azure-devops-mcp/commit/6bee365d9b37f7e197eaff03065e713ab0ee1c5f))
* add get_pull_request_comments ([2b7fb3a](https://github.com/keith-hung/azure-devops-mcp/commit/2b7fb3a885466c633d2d2dfdd8906cc9573483d9))
* add get-file-content feature to access repository content ([a282f75](https://github.com/keith-hung/azure-devops-mcp/commit/a282f75383ffc362e5b2d1ecbccebb0047e21571))
* add listWikiPages functionality to Azure DevOps wiki client ([bb9ddc0](https://github.com/keith-hung/azure-devops-mcp/commit/bb9ddc077e80be0caeda106a7e75dc336a62c9ae))
* Add npm publish to release.yml ([50d0368](https://github.com/keith-hung/azure-devops-mcp/commit/50d0368c090adc39a9b3ece67d198cabcd18c6ce))
* add pre-commit hook for prettier and eslint ([1b4ddff](https://github.com/keith-hung/azure-devops-mcp/commit/1b4ddff90e3c3ab9954d041398d224f03c632f63))
* add project-level pull request query functionality ([6ebcde8](https://github.com/keith-hung/azure-devops-mcp/commit/6ebcde8cd59f8c9e317254b25203fd8b39cc2a48))
* add update-pull-request tool to tool-definitions and implement reviewer management ([b7b5398](https://github.com/keith-hung/azure-devops-mcp/commit/b7b539813baadb84e15022fdb93d24f440491d94))
* add username/password authentication for TFS/Azure DevOps Server on-premises ([ce073ea](https://github.com/keith-hung/azure-devops-mcp/commit/ce073ea19c204f9d933ab99de738d1fe9327d582))
* add_pull_request_comment ([1df6161](https://github.com/keith-hung/azure-devops-mcp/commit/1df616161835e11c0039bc344ccdc57742f79507))
* create pull request ([ab9c255](https://github.com/keith-hung/azure-devops-mcp/commit/ab9c2554ea82a497dead8131a6479ba6fe7c5ba8))
* enhance GitHub release notes with changelog content ([2fb275d](https://github.com/keith-hung/azure-devops-mcp/commit/2fb275d38acbc9c092584573a549466ccd5482bc))
* **getWorkItem:** enhance get_work_item to include all available fields ([3810660](https://github.com/keith-hung/azure-devops-mcp/commit/38106600f04842a44e5e5b6e824716ebb6f69e61))
* implement automated release workflow ([9e5a5df](https://github.com/keith-hung/azure-devops-mcp/commit/9e5a5dfacdd87ca933ed02efbd0aa8035239332d))
* implement create_wiki_page feature for Azure DevOps wiki API integration ([#225](https://github.com/keith-hung/azure-devops-mcp/issues/225)) ([7e3294d](https://github.com/keith-hung/azure-devops-mcp/commit/7e3294d1f1b6e82d5ca34cf86f3eaa51579dad02))
* implement get_me tool ([2a3849d](https://github.com/keith-hung/azure-devops-mcp/commit/2a3849da063f6ce0877dd672992a8bc19f88230e))
* implement get_project_details core functionality ([6d93d98](https://github.com/keith-hung/azure-devops-mcp/commit/6d93d9820c4bd3ce8bc257d05ff04b39d1370a19)), closes [#101](https://github.com/keith-hung/azure-devops-mcp/issues/101)
* implement get_repository_details core functionality ([dcef80b](https://github.com/keith-hung/azure-devops-mcp/commit/dcef80b922ef338f6d3704ab30f59c1b126c70ee))
* implement human-readable string enums for Azure DevOps API responses ([8168bcb](https://github.com/keith-hung/azure-devops-mcp/commit/8168bcbe8e4957e9632927f57ecbe9632c911735))
* implement manage work item link handler ([72cd641](https://github.com/keith-hung/azure-devops-mcp/commit/72cd6419cf804eb0d72d5ba7763ad5b46bc35650))
* implement search_wiki handler with tests ([286598c](https://github.com/keith-hung/azure-devops-mcp/commit/286598c47052ade3b6a524938046b3e3b9341b3a))
* implement search_work_items handler with tests ([e244658](https://github.com/keith-hung/azure-devops-mcp/commit/e2446587e6f82fb7e2dbfe47d2d034ecfdfc3189))
* limit search results to 10 when includeContent is true ([827e4e6](https://github.com/keith-hung/azure-devops-mcp/commit/827e4e65be353125f5ae595b7e68d80f614f8c07))
* make projectId optional in search features for organization-wide search ([1ca1e0e](https://github.com/keith-hung/azure-devops-mcp/commit/1ca1e0e146bf880d367078b02a2ddaebf6f54a2a))
* **pipeline:** implement get-pipeline functionality ([#166](https://github.com/keith-hung/azure-devops-mcp/issues/166)) ([e307340](https://github.com/keith-hung/azure-devops-mcp/commit/e3073401e141b566191be16ed4f9b7925c2849eb))
* **pipeline:** implement list-pipelines ([#161](https://github.com/keith-hung/azure-devops-mcp/issues/161)) ([89ce473](https://github.com/keith-hung/azure-devops-mcp/commit/89ce4732ba754632540ffb45ceae323f9675c023)), closes [#94](https://github.com/keith-hung/azure-devops-mcp/issues/94)
* **pipelines:** implement trigger-pipeline functionality ([e9ba71b](https://github.com/keith-hung/azure-devops-mcp/commit/e9ba71bfeb2c3a2dc0e1e314698a453d5995d099))
* **pull-requests:** enhance get_pull_request_comments response with … ([#229](https://github.com/keith-hung/azure-devops-mcp/issues/229)) ([6997a04](https://github.com/keith-hung/azure-devops-mcp/commit/6997a04e92b4fe453354b8fd9f0f25c974fcad2b))
* **pull-requests:** implement list-pull-requests functionality ([3f8cac4](https://github.com/keith-hung/azure-devops-mcp/commit/3f8cac448e2adacaddeb069bc0116b8526577624))
* **repositories:** add get_all_repositories_tree tool for viewing multi-repository file structure ([adbe206](https://github.com/keith-hung/azure-devops-mcp/commit/adbe206300d55ba06063c675492b3a8153b688f7))
* restore get_file_content tool and update documentation ([f71013a](https://github.com/keith-hung/azure-devops-mcp/commit/f71013a962fb5fbe5d121eaf7f1901e58cf70482))
* **search:** add code search functionality for Azure DevOps repos ([0680102](https://github.com/keith-hung/azure-devops-mcp/commit/068010236b10d8ed444ec01bd6820b27c5c9dcdc))
* support default project and organization in all tools ([5beca06](https://github.com/keith-hung/azure-devops-mcp/commit/5beca063057bdbc2dd869c865fb01e0d311c8917))
* support default project and organization in all tools ([96d61bd](https://github.com/keith-hung/azure-devops-mcp/commit/96d61bd1098146dfafd1faf7dade1a37725cd7b7))
* **wikis:** add create and update wiki functionalities ([27edd6d](https://github.com/keith-hung/azure-devops-mcp/commit/27edd6d7786748548f4a0123ff19be43b30265c4))
* **wikis:** implement `get_wiki_page` tool ([7ba5fd7](https://github.com/keith-hung/azure-devops-mcp/commit/7ba5fd7830fefa17c014aa2b80f0bad04d8fcbf7))
* **wikis:** implement `get_wikis` tool ([3120479](https://github.com/keith-hung/azure-devops-mcp/commit/3120479b5c31bfaeb50a507791056066f33b6534))


### Bug Fixes

* add bin field to make package executable with npx ([2d3d5fa](https://github.com/keith-hung/azure-devops-mcp/commit/2d3d5fa31a9ba741c4a85d7ef21d72ff46270695))
* add build step to workflow and ensure dist files are included in package ([6e12d3c](https://github.com/keith-hung/azure-devops-mcp/commit/6e12d3ca666937c7b24c7c5d8b161fbb8e34798c))
* add explicit permissions to workflow file ([ae85b95](https://github.com/keith-hung/azure-devops-mcp/commit/ae85b953d2467538e42d8c6853b93e1af3c8ed51))
* add guidance for HTML formatting in multi-line text fields ([#188](https://github.com/keith-hung/azure-devops-mcp/issues/188)) ([25751cd](https://github.com/keith-hung/azure-devops-mcp/commit/25751cd0d7cb8919a7bca80d0796784935f0fbed)), closes [#179](https://github.com/keith-hung/azure-devops-mcp/issues/179)
* add missing minimatch module ([ee1ffa3](https://github.com/keith-hung/azure-devops-mcp/commit/ee1ffa34afb0da9cdac31da140c17dbd9c589c2b))
* add parent-child relationship support for createWorkItem ([31d5efe](https://github.com/keith-hung/azure-devops-mcp/commit/31d5efef49c162772e64eabd1e4012d8143dc270))
* add tag_name parameter to GitHub release action ([68cfa43](https://github.com/keith-hung/azure-devops-mcp/commit/68cfa43839c5975cdf9c2ec8a5348ace6138d1c2))
* add zod-to-json-schema dependency and remove unused packages from package-lock.json ([c9c117f](https://github.com/keith-hung/azure-devops-mcp/commit/c9c117fd388e228c1116d9249698d931557877b7))
* allow parameterless tools to be called without arguments ([9ce88c3](https://github.com/keith-hung/azure-devops-mcp/commit/9ce88c3afd4454b8a65392a98e7e2ffb45192584))
* correct [Object Object] display in search_code includeContent ([bdabd6b](https://github.com/keith-hung/azure-devops-mcp/commit/bdabd6bbeb3f60347c37499bdcb621f5c206dfe0))
* correct authentication architecture in update-pull-request ([a19a64d](https://github.com/keith-hung/azure-devops-mcp/commit/a19a64d538bc3d48a572498ae300c18b83d7bec0))
* enhanced the get-pull-request-comments tool to include path and line number ([f6017e5](https://github.com/keith-hung/azure-devops-mcp/commit/f6017e5dd352b63b189e761c9cf27d103dd24b9d))
* get_me support for visualstudio.com urls ([ffd3c8a](https://github.com/keith-hung/azure-devops-mcp/commit/ffd3c8a34bcee1856911e5eed7b719d524c25fef))
* getMe profile bug ([ceca909](https://github.com/keith-hung/azure-devops-mcp/commit/ceca909beaa74b0dd150ce1688a498281fd0b9e8))
* implement pagination for list-pull-requests to prevent infinite loop ([#196](https://github.com/keith-hung/azure-devops-mcp/issues/196)) ([e3d7f32](https://github.com/keith-hung/azure-devops-mcp/commit/e3d7f321f11241bd7b45a4f0e6810509cc8c01c1))
* improve cross-platform CLI compatibility for Windows ([0f6ed3f](https://github.com/keith-hung/azure-devops-mcp/commit/0f6ed3fe7c72ba63ec5485047ce52e06278457ab))
* improve org name extraction from url ([496abc7](https://github.com/keith-hung/azure-devops-mcp/commit/496abc7a9c5fd0867cf8484f8c33c47a3cc42edf))
* make AZURE_DEVOPS_AUTH_METHOD parameter case-insensitive ([9bbf53f](https://github.com/keith-hung/azure-devops-mcp/commit/9bbf53ffcc1a9170e6ba038fee182da0621be777))
* only request max 200 by default ([296de35](https://github.com/keith-hung/azure-devops-mcp/commit/296de3584346bd05c14dec3b39dff9a5ec0036a5))
* package.json & package-lock.json to reduce vulnerabilities ([2fb1e72](https://github.com/keith-hung/azure-devops-mcp/commit/2fb1e725120edc75c9897bc81f57381c20ad880a))
* **pull-requests:** update repository name environment variable ([d2fde5f](https://github.com/keith-hung/azure-devops-mcp/commit/d2fde5f94280f08056f94b613a673d4bbe9c0192))
* refine WIQL query in integration test ([eb32e43](https://github.com/keith-hung/azure-devops-mcp/commit/eb32e43a9064485d29661bcae99a987e3b863464))
* remove schema validation for parameterless tools ([031a71d](https://github.com/keith-hung/azure-devops-mcp/commit/031a71d71083649216e5b67eb6d67c18c78702bd))
* remove uuid() validator to resolve unknown format error ([b251252](https://github.com/keith-hung/azure-devops-mcp/commit/b251252c7c455ee11d8076380b70a546ebf40a6e))
* resolve npm publish authentication and package content issues ([96e91d0](https://github.com/keith-hung/azure-devops-mcp/commit/96e91d04ec620ad77fc35fea31c2b7795fb73d9e))
* resolve parameter conflict in getItemContent function ([38d624c](https://github.com/keith-hung/azure-devops-mcp/commit/38d624c10dcfad26bab6d04a9290ad05097f5052))
* restore tests/setup.ts to fix test suite ([5e23eab](https://github.com/keith-hung/azure-devops-mcp/commit/5e23eab1228f3949c431f1b8509ad5fbf829e528))
* return actual field information from get_project_details tool ([64a030a](https://github.com/keith-hung/azure-devops-mcp/commit/64a030a8c14fd1f9e7f871ae409f0dded23dbe98))
* revert to direct execution of index.js to fix main module detection ([82efa90](https://github.com/keith-hung/azure-devops-mcp/commit/82efa90852f56db3a0b028ec50eb5230072da88a))
* search_work_items authentication with Azure Identity ([cdb2e72](https://github.com/keith-hung/azure-devops-mcp/commit/cdb2e722ee3abf6be465adcad7dc294f7c623103))
* simplify content handling in search_code to properly process ReadableStream ([136a90a](https://github.com/keith-hung/azure-devops-mcp/commit/136a90a94f446e2c4227d87286b8d71ef8223212))
* simplify listWikiPages API by removing unused parameters ([fff7238](https://github.com/keith-hung/azure-devops-mcp/commit/fff72384f69433942ee8439de0dda90d7fc85c38))
* standardize authentication architecture across all API features ([d02ca39](https://github.com/keith-hung/azure-devops-mcp/commit/d02ca3945af0f24ea939c999636b2e1d6b3c761e))
* Typo in release.yaml workflow ([e0de15f](https://github.com/keith-hung/azure-devops-mcp/commit/e0de15fd220ef2141466cf0530383921ed99253d))
* update creatorId and reviewerId to require UUIDs instead of allowing emails ([09e82ef](https://github.com/keith-hung/azure-devops-mcp/commit/09e82ef5e7dfdcd07d1851450ea8c488ea8bb82a))
* use default project for code search when no projectId is specified ([#202](https://github.com/keith-hung/azure-devops-mcp/issues/202)) ([3bf118f](https://github.com/keith-hung/azure-devops-mcp/commit/3bf118f45b4222bbfaf888deb67d546b87afc2fe))
* **work-items:** make expand enum compatible with Gemini CLI ([#240](https://github.com/keith-hung/azure-devops-mcp/issues/240)) ([ac1dcac](https://github.com/keith-hung/azure-devops-mcp/commit/ac1dcace4cd6f63d5decd4820307b52a4d0d431d))


### Performance Improvements

* optimize git hooks with lint-staged ([ba953d8](https://github.com/keith-hung/azure-devops-mcp/commit/ba953d84706893d56a82573c8d9e8ecdf3b09591))
